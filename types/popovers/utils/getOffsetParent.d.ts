...
export declare const getContainingBlock: (node: Element, callback?: (node: Element | null) => unknown) => Node | null;
 ...
 */
export declare const getOffsetParent: (node: Element | HTMLElement, callback?: (node: Element | null) => unknown) => Element | Node | Window | null;

...
const routes = [
  ...
  {
    path: '/ClockSpin',
    component: lazy(() => import('./ClockSpin')),
  },
  {
    path: '/Sudoku',
  ...
  {
    path: '/CircleSpin',
    component: lazy(() => import('./CircleSpin')),
  },
  {
    path: '/BallSpin',
  ...
  {
    path: '/ScrollBox',
    component: lazy(() => import('./ScrollBox')),
  },
  {
    path: '/MasonryWithPull',
    component: lazy(() => import('./MasonryWithPull')),
  },
  {
    path: '/AspectRatio',
  ...
  {
    path: '/UseListHook',
    component: lazy(() => import('./UseListHook')),
  },
  {
    path: '/Masonry',
    component: lazy(() => import('./Masonry')),
  },
  {
    path: '/guide',

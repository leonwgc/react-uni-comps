  ...
  return (
    <div>
      ...
      <Cell
        ...
        content={<IconArrow direction="right" />}
        onClick={() => gotoPage('Turntable')}
      ></Cell>
      <Cell
        label={
          <Space>
            <IconComponent /> SlideCard
          </Space>
        }
        content={<IconArrow direction="right" />}
        onClick={() => gotoPage('SlideCard')}
      ></Cell>
      <Cell
        label={
          <Space>
            <IconComponent /> Countdown
          </Space>
        }
        content={<IconArrow direction="right" />}
        onClick={() => gotoPage('Countdown')}
      ></Cell>
      <Cell
        label={
          <Space>
      ...
      <Cell
        label={
          <Space>
            <IconComponent /> RoundSpin
          </Space>
        }
        content={<IconArrow direction="right" />}
        onClick={() => gotoPage('RoundSpin')}
      ></Cell>
      <Cell
        label={
          <Space>
      ...
      <Cell
        label={
          <Space>
            <IconComponent /> Masonry
          </Space>
        }
        content={<IconArrow direction="right" />}
        onClick={() => gotoPage('Masonry')}
      ></Cell>
      <Cell
        label={
          <Space>
      ...
      <Cell
        ...
        content={<IconArrow direction="right" />}
        onClick={() => gotoPage('Mask')}
      ></Cell>
      <Cell
        label={
          <Space>
            <IconComponent /> Result
          </Space>
        }
        content={<IconArrow direction="right" />}

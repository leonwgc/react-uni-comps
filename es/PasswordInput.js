...
var PasswordInput = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var _a = props.value,
      ...
      rest = __rest(props, ["value", "length", "className", "mask", "autoFocus", "onFinish", "onChange"]);
    ...
    return {
      focus: function focus() {
        setTimeout(function () {
          ...
          (_b = (_a = inputRefArray.current[vRef.current.length]).focus) === null || _b === void 0 ? void 0 : _b.call(_a);
        }, 60);
      }
    };
  });
  ...
  return /*#__PURE__*/React.createElement(StyledPasswordInput, __assign({}, rest, {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "dot"
    }) : value[idx] : /*#__PURE__*/React.createElement("input", {
      ref: function ref(r) {

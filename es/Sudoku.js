...
var Sudoku = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var className = props.className,
      ...
      _d = props.gap,
      gap = _d === void 0 ? 4 : _d,
      rest = __rest(props, ["className", "pointer", "prizeList", "round", "speed", "onStart", "onEnd", "gap"]);

...
var Button = function Button(props) {
  var _a = props.color,
      ...
      _d = props.height,
      height = _d === void 0 ? 32 : _d,
      htmlType = props.htmlType,
      circle = props.circle,
      dashed = props.dashed,
      rest = __rest(props, ["color", "type", "disabled", "block", "className", "style", "children", "height", "htmlType", "circle", "dashed"]);

  var themeColor = disabled ? colors.disabled : color;
